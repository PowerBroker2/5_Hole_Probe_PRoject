...
#define WAIT_TIME 150 //number of ms between servo position adjustments
#define AOA_MAX 110   //AOA servo max angle
#define AOA_MIN 70    //AOA servo min angle
#define SSA_MAX 110   //SSA servo max angle
#define SSA_MIN 70    //SSA servo min angle
